                ...
                >
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-[#E8E2D8] pb-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="font-mono text-xs text-[#1A1816] font-semibold truncate max-w-xs">
                    ...
                    <a
                      ...
                      rel="noreferrer"
                      className="px-3.5 py-1.5 bg-[#FAF8F5] text-[#1A1816] font-mono text-[10px] uppercase tracking-[0.15em] rounded-[2px] border border-[#E8E2D8] hover:border-[#1A1816] shadow-xs flex items-center gap-1.5 transition-colors"
                    >
                      <Download className="w-3.5 h-3.5" /> Download High-Res Master
                    </a>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-5 items-center">
                    {/* Visual Preview */}
                    <div className="sm:col-span-4 aspect-[4/3] rounded-[2px] bg-[#F4F0E8] border border-[#E8E2D8] p-2 overflow-hidden relative">
                      <img
                        src={item.photoUrl}
